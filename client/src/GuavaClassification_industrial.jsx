...
function GuavaSeedDetection() {
  ...
  useEffect(() => {
    const Ref = ref(db, "guava_predictions");
  ...
  useEffect(() => {
    const topRef = ref(db, "guava_predictions_top");
  ...
  useEffect(() => {
    const bottomRef = ref(db, "guava_predictions_bottom");
              ...
              <h1 className="text-4xl font-bold leading-10 text-gray-800 md:text-7xl">
                ...
                <span className="text-green-700">
                  <p className="text-5xl font-bold text-green-700">
                    <p className="text-5xl font-bold text-green-700">
                      {latestTopPrediction.prediction
                        ? latestTopPrediction.prediction
                            .charAt(0)
                            .toUpperCase() +
                          latestTopPrediction.prediction.slice(1).toLowerCase()
                        : "Unknown"}
                    </p>
                  </p>
                </span>
...
export default GuavaSeedDetection;