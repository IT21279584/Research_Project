...
function SoybeanSeedDetection() {
  ...
  useEffect(() => {
    const Ref = ref(db, "soybean_predictions");
  ...
  useEffect(() => {
    const topRef = ref(db, "soybean_predictions_top");
  ...
  useEffect(() => {
    const bottomRef = ref(db, "soybean_predictions_bottom");
        ...
        <div className="flex flex-col items-center w-full px-6 mb-4 text-center md:flex-row md:px-24">
          <div className="pr-6 text-center md:w-1/2 md:text-left">
              ...
              <span className="text-green-700">
                <p className="text-6xl font-bold text-green-700 md:text-7xl">
                  {latestPrediction.predicted_class
                    ? latestPrediction.predicted_class.charAt(0).toUpperCase() +
                      latestPrediction.predicted_class.slice(1).toLowerCase()
                    : "Unknown"}
                </p>
              </span>
            </h1>
            ...
            <p className="mt-2 text-lg text-gray-600">
              ...
              <span> {latestPrediction.predicted_class || "unknown"}</span>,
...
export default SoybeanSeedDetection;